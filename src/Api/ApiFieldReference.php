...
class ApiFieldReference
{
    ...
    public static function campaignPostFields(): array
    {
        return [
            ...
            ['field' => 'allow_multiple_conversions', 'type' => 'boolean', 'required' => false, 'description' => 'When true, accept additional postbacks on the same click_id without a new txid (e.g. Propush multi-earn). Default false.'],
    ...
    public static function campaignResponseFieldsFull(): array
    {
        return [
            ...
            ['field' => 'allow_multiple_conversions', 'type' => 'boolean', 'required' => false, 'description' => 'Allow multiple conversions on the same click_id (Propush-style).'],
